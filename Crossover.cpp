...
Individual TwoPointCrossover::createOffspring(const Individual& parent1, const Individual& parent2) const
{
	...
	Node* offspring = parent1.getRoot()->createTreeCopyWithReplacePoint(point1, subtree); 
